# Anapioficeandfire SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AnapioficeandfireSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AnapioficeandfireSDK(...) and AnapioficeandfireSDK.test(...) become
#      AnapioficeandfireSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "anapioficeandfire_sdk"
_SDK_CLASS = "AnapioficeandfireSDK"
