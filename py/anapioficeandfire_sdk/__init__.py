...
from anapioficeandfire_sdk.utility import register

# Load features
from anapioficeandfire_sdk.feature.base_feature import AnapioficeandfireBaseFeature
from anapioficeandfire_sdk.features import _has_feature, _make_feature
...
class AnapioficeandfireSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AnapioficeandfireUtility()
    ...
    def get_utility(self):
        return AnapioficeandfireUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AnapioficeandfireSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Book(self, data=None) -> "BookEntity":
        ...
        from anapioficeandfire_sdk.entity.book_entity import BookEntity
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from anapioficeandfire_sdk.entity.character_entity import CharacterEntity
    ...
    def House(self, data=None) -> "HouseEntity":
        ...
        from anapioficeandfire_sdk.entity.house_entity import HouseEntity
