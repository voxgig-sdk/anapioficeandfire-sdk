...
// Anapioficeandfire SDK utility type

class AnapioficeandfireUtility
{
    ...
    public static function copy(AnapioficeandfireUtility $src): AnapioficeandfireUtility
    {
        $u = new AnapioficeandfireUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
