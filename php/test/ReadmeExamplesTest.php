...
// Anapioficeandfire SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AnapioficeandfireSDK::test)
...
{
    private const SDK_CLASS = 'AnapioficeandfireSDK';
    ...
    private const SDK_BASE = 'anapioficeandfire_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../anapioficeandfire_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
