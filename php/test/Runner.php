...
class AnapioficeandfireTestRunner
{
    ...
    {
        $live = self::getenv('ANAPIOFICEANDFIRE_TEST_LIVE');
        $override = self::getenv('ANAPIOFICEANDFIRE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ANAPIOFICEANDFIRE_TEST_EXPLAIN');
...
class_alias('AnapioficeandfireTestRunner', 'Runner');
class_alias('AnapioficeandfireHelpers', 'Helpers');
