...
class BookEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ANAPIOFICEANDFIRE_TEST_BOOK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function book_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ANAPIOFICEANDFIRE_TEST_BOOK_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["ANAPIOFICEANDFIRE_TEST_BOOK_ENTID"]);
