...
// Anapioficeandfire SDK utility: fetcher

class AnapioficeandfireFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AnapioficeandfireSDK/1.0)';
    ...
    public static function call(AnapioficeandfireContext $ctx, string $fullurl, array $fetchdef): array
    {
