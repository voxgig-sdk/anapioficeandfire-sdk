...
// Anapioficeandfire SDK utility: result_basic

class AnapioficeandfireResultBasic
{
    public static function call(AnapioficeandfireContext $ctx): ?AnapioficeandfireResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AnapioficeandfireError) ? $result->err->msg : (string)$result->err;
