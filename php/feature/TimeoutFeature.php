...
// Anapioficeandfire SDK timeout feature
...
class AnapioficeandfireTimeoutFeature extends AnapioficeandfireBaseFeature
{
    ...
    private function _with_timeout(AnapioficeandfireContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AnapioficeandfireContext $_ctx, float $ms): void
    {
        $client = $this->client;
