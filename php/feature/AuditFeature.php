...
// Anapioficeandfire SDK audit feature
...
class AnapioficeandfireAuditFeature extends AnapioficeandfireBaseFeature
{
    ...
    private function _emit(AnapioficeandfireContext $ctx, string $outcome): void
    {
