...
// Anapioficeandfire SDK proxy feature
...
class AnapioficeandfireProxyFeature extends AnapioficeandfireBaseFeature
{
    ...
    public function init(AnapioficeandfireContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AnapioficeandfireContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
