...
// Anapioficeandfire SDK metrics feature
...
class AnapioficeandfireMetricsFeature extends AnapioficeandfireBaseFeature
{
    ...
    private function _record(AnapioficeandfireContext $ctx, bool $ok): void
    {
