...
from projectname_sdk.core.control import AnapioficeandfireControl
...
class AnapioficeandfireContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AnapioficeandfireControl()
        ...
        if isinstance(sp, AnapioficeandfireSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AnapioficeandfireResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AnapioficeandfireResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AnapioficeandfireOperation({})
    ...
    def make_error(self, code, msg):
        return AnapioficeandfireError(code, msg, self)
