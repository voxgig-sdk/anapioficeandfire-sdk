...
// Anapioficeandfire SDK rbac feature
...
class AnapioficeandfireRbacFeature extends AnapioficeandfireBaseFeature
{
    ...
    private function _required(AnapioficeandfireContext $ctx): ?string
    {
    ...
    private function _reject(AnapioficeandfireContext $ctx, string $required): void
    {
    ...
    private function _track(AnapioficeandfireContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
