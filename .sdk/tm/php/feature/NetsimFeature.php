...
// Anapioficeandfire SDK netsim feature
...
class AnapioficeandfireNetsimFeature extends AnapioficeandfireBaseFeature
{
    ...
    private function _simulate(AnapioficeandfireContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AnapioficeandfireContext $ctx, array $applied): void
    {
        $client = $this->client;
