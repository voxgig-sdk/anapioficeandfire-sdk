...
// Anapioficeandfire SDK clienttrack feature
...
class AnapioficeandfireClienttrackFeature extends AnapioficeandfireBaseFeature
{
    ...
    public function PostConstruct(AnapioficeandfireContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Anapioficeandfire-SDK';
