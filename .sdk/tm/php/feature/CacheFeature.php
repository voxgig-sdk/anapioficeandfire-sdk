...
// Anapioficeandfire SDK cache feature
...
class AnapioficeandfireCacheFeature extends AnapioficeandfireBaseFeature
{
    ...
    private function _through(AnapioficeandfireContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
