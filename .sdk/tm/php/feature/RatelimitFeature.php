...
// Anapioficeandfire SDK ratelimit feature
...
class AnapioficeandfireRatelimitFeature extends AnapioficeandfireBaseFeature
{
    ...
    private function _acquire(AnapioficeandfireContext $ctx): void
    {
    ...
    private function _track(AnapioficeandfireContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
