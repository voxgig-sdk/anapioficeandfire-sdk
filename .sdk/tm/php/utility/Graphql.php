...
// Anapioficeandfire SDK utility: graphql
//
...
class AnapioficeandfireGraphql
{
    ...
    // equivalent.
    public static function body(AnapioficeandfireContext $ctx): mixed
    {
    ...
    public static function errors(AnapioficeandfireContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
