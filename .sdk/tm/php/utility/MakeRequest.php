...
// Anapioficeandfire SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AnapioficeandfireMakeRequest
{
    public static function call(AnapioficeandfireContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AnapioficeandfireResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AnapioficeandfireResponse($fetched);
        } else {
