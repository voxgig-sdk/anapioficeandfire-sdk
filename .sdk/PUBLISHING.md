...
|---|---|---|
| `ts/` | @voxgig-sdk/anapioficeandfire-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/anapioficeandfire-sdk \
      --repository voxgig-sdk/anapioficeandfire-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/anapioficeandfire-sdk` shows it, and
`npm trust revoke @voxgig-sdk/anapioficeandfire-sdk --id=<id>` removes it.
