...
AQL-driven CLI and REPL for the Anapioficeandfire SDK. Positional arguments are
...
```sh
go build -o anapioficeandfire-cli ./...
```
...
./anapioficeandfire-cli load 1 book
./anapioficeandfire-cli load '{id:1}' book
