# Anapioficeandfire SDK Book entity
...
class BookEntity
  ...
  # @return [Book, Hash] the loaded Book; raises AnapioficeandfireError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Book>, Array] the matching Book items; raises AnapioficeandfireError on failure
