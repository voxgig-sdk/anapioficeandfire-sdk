...
#      offline in seeded test mode (AnapioficeandfireSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Anapioficeandfire_sdk.rb")
  SDK_CLASS = "AnapioficeandfireSDK"
  ...
  SDK_BASE = "Anapioficeandfire_sdk"
