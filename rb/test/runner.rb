...
module AnapioficeandfireTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("ANAPIOFICEANDFIRE_TEST_LIVE")
    override = getenv("ANAPIOFICEANDFIRE_TEST_OVERRIDE")
    ...
    explain = getenv("ANAPIOFICEANDFIRE_TEST_EXPLAIN")
    m["ANAPIOFICEANDFIRE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AnapioficeandfireTestRunner
Helpers = AnapioficeandfireHelpers
Vs = VoxgigStruct
