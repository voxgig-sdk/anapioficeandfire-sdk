...
class BookEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ANAPIOFICEANDFIRE_TEST_BOOK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def book_basic_setup(extra)
  ...
  entid_env_raw = ENV["ANAPIOFICEANDFIRE_TEST_BOOK_ENTID"]
