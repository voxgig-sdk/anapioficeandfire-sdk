...
(0, node_test_1.describe)('HouseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AnapioficeandfireSDK({
    ...
    (0, node_test_1.test)('direct-load-house', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-house', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-house', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-house', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.ANAPIOFICEANDFIRE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AnapioficeandfireSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ANAPIOFICEANDFIRE_TEST_HOUSE_ENTID'];
    ...
    const client = new __1.AnapioficeandfireSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=HouseDirect.test.js.map