...
function envOverride(m) {
    if ('TRUE' === process.env.ANAPIOFICEANDFIRE_TEST_LIVE ||
        'TRUE' === process.env.ANAPIOFICEANDFIRE_TEST_OVERRIDE) {
    ...
    m.ANAPIOFICEANDFIRE_TEST_EXPLAIN = process.env.ANAPIOFICEANDFIRE_TEST_EXPLAIN || m.ANAPIOFICEANDFIRE_TEST_EXPLAIN;
    return m;
}
