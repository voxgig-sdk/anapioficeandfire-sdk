...
The Lua SDK for the Anapioficeandfire API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:Anapioficeandfire(nil):load(
  { id = "test01" }, nil
)
