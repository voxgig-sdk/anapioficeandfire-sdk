...
function runner.env_override(m)
  local live = runner.getenv("ANAPIOFICEANDFIRE_TEST_LIVE")
  local override = runner.getenv("ANAPIOFICEANDFIRE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ANAPIOFICEANDFIRE_TEST_EXPLAIN")
