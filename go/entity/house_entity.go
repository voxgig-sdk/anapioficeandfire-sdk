...
type HouseEntity struct {
	name    string
	client  *core.AnapioficeandfireSDK
...
func NewHouseEntity(client *core.AnapioficeandfireSDK, entopts map[string]any) *HouseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HouseEntity) GetName() string { return e.name }
...
func (e *HouseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HouseEntity) Deleted() bool {
	return e.deleted
}


func (e *HouseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHouseEntity(e.client, opts)
}

func (e *HouseEntity) Data(args ...any) any {
...
func (e *HouseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an House; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HouseEntity) DataTyped(data ...House) House {
	if len(data) > 0 {
		return typedFrom[House](e.Data(asMap(data[0])))
	}
	return typedFrom[House](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through House (all fields
// optional at the wire level).
func (e *HouseEntity) MatchTyped(match ...House) House {
	if len(match) > 0 {
		return typedFrom[House](e.Match(asMap(match[0])))
	}
	return typedFrom[House](e.Match())
}
...
func (e *HouseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HouseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HouseLoadMatch and returns an House. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HouseEntity) LoadTyped(reqmatch HouseLoadMatch, ctrl map[string]any) (House, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return House{}, err
	}
	return typedFrom[House](res), nil
}




func (e *HouseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// HouseListMatch and returns []House. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HouseEntity) ListTyped(reqmatch HouseListMatch, ctrl map[string]any) ([]House, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[House](res), nil
}



func (e *HouseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HouseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HouseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HouseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
