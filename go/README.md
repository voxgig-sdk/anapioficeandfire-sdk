...
The Golang SDK for the Anapioficeandfire API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/anapioficeandfire-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/anapioficeandfire-sdk=../path/to/github.com/voxgig-sdk/anapioficeandfire-sdk
```
...
```
github.com/voxgig-sdk/anapioficeandfire-sdk/
...
The root package (`github.com/voxgig-sdk/anapioficeandfire-sdk`) re-exports everything needed
