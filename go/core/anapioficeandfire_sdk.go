...
type AnapioficeandfireSDK struct {
	Mode     string
...
func (sdk *AnapioficeandfireSDK) OptionsMap() map[string]any {
...
func (sdk *AnapioficeandfireSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AnapioficeandfireSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AnapioficeandfireSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AnapioficeandfireSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AnapioficeandfireSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AnapioficeandfireSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AnapioficeandfireSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AnapioficeandfireSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AnapioficeandfireSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AnapioficeandfireSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AnapioficeandfireSDK {
	if sdkopts == nil {
	...
	sdk := NewAnapioficeandfireSDK(sdkopts)
	sdk.Mode = "test"
